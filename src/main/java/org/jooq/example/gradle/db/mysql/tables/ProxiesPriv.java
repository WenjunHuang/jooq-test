...
public class ProxiesPriv extends TableImpl<ProxiesPrivRecord> {
    ...
    private static final long serialVersionUID = -506117540;
     ...
     */
    public final TableField<ProxiesPrivRecord, String> GRANTOR = createField("Grantor", org.jooq.impl.SQLDataType.CHAR.length(93).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");
