...
public class ProcsPriv extends TableImpl<ProcsPrivRecord> {
    ...
    private static final long serialVersionUID = -172605927;
     ...
     */
    public final TableField<ProcsPrivRecord, String> GRANTOR = createField("Grantor", org.jooq.impl.SQLDataType.CHAR.length(93).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");
