...
public class FormatPath extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = 2032438632;
     ...
     */
    public static final Parameter<String> IN_PATH = createParameter("in_path", org.jooq.impl.SQLDataType.VARCHAR.length(512), false, false);
