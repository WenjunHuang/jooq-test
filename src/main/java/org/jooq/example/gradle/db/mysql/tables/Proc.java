...
public class Proc extends TableImpl<ProcRecord> {
    ...
    private static final long serialVersionUID = 345515402;
     ...
     */
    public final TableField<ProcRecord, String> DEFINER = createField("definer", org.jooq.impl.SQLDataType.CHAR.length(93).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");
