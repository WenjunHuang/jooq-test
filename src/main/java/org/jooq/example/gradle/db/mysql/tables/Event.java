...
public class Event extends TableImpl<EventRecord> {
    ...
    private static final long serialVersionUID = -557257562;
     ...
     */
    public final TableField<EventRecord, String> DEFINER = createField("definer", org.jooq.impl.SQLDataType.CHAR.length(93).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");
