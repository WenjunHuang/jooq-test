...
public class Version extends TableImpl<VersionRecord> {
    ...
    private static final long serialVersionUID = 1210275049;
     ...
     */
    public final TableField<VersionRecord, String> MYSQL_VERSION = createField("mysql_version", org.jooq.impl.SQLDataType.VARCHAR.length(6).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
